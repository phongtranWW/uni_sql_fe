    ...
    >
      <div className="flex flex-col gap-8 p-8">
        ...
        <div className="flex flex-col gap-3">
          ...
          <Button
            variant="outline"
            className="w-full gap-2.5 cursor-not-allowed opacity-50"
            disabled
            title="Coming soon"
          >
            <GithubIcon />
            Continue with Github
            <span className="ml-auto rounded-full border border-border px-1.5 py-0.5 text-[10px] font-medium tracking-wide text-muted-foreground">
              SOON
            </span>
          </Button>
        </div>
      </div>
      <div className="rounded-b-2xl border-t border-border/60 bg-muted/30 px-8 py-4 text-center text-xs text-muted-foreground">
